...
# apps/browser-demos/public/mariadb.vfs.zst (wasm32) or apps/browser-demos/public/mariadb-64.vfs.zst
...
case "$arch" in
    wasm32)
        bash "$REPO_ROOT/images/vfs/scripts/build-mariadb-vfs-image.sh"
        VFS="$REPO_ROOT/apps/browser-demos/public/mariadb.vfs.zst"
        ;;
    wasm64)
        bash "$REPO_ROOT/images/vfs/scripts/build-mariadb-vfs-image.sh" --wasm64
        VFS="$REPO_ROOT/apps/browser-demos/public/mariadb-64.vfs.zst"
        ;;
    *)
