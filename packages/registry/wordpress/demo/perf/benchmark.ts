 ...
 *
 * Usage:
 *   npx tsx packages/registry/wordpress/demo/perf/benchmark.ts
 *   npx tsx packages/registry/wordpress/demo/perf/benchmark.ts --rounds=5
 *   npx tsx packages/registry/wordpress/demo/perf/benchmark.ts --headed
 */
...
async function startServer(port: number): Promise<{ proc: ChildProcess; startupMs: number }> {
  ...
  const proc = spawn(
    "npx",
    ["tsx", "packages/registry/wordpress/demo/serve-nginx.ts", String(port)],
    {
      cwd: REPO_ROOT,
