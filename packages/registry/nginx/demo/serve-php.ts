 ...
 *
 * Usage:
 *   npx tsx packages/registry/nginx/demo/serve-php.ts
 *
...
async function main() {
  const phpFpmWasm = resolveBinary("programs/php/php-fpm.wasm");
  const nginxWasm = resolveBinary("programs/nginx.wasm");
