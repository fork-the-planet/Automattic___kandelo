/* wasm32posix override: kernel-managed pshared mutexes route through the
 * kernel; everything else falls through to musl's native timedlock logic
 * (copied verbatim from libc/musl/src/thread/pthread_mutex_timedlock.c).
 *
