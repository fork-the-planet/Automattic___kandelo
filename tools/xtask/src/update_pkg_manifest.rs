//! Publish-time writeback into `packages/registry/<name>/package.toml`.
//!
...
"#;
    ...
    // hits the bare `[binary]` block. Mirrors packages/registry/dinit/.
...
[build]
script_path = "packages/registry/weird/build.sh"
...
[build]
script_path = "packages/registry/se/build.sh"
...
[build]
script_path = "packages/registry/im/build.sh"
...
[build]
script_path = "packages/registry/m/build.sh"
